...
from openprocurement.tender.limited.validation import (
    validate_cancellation_in_termainated_status, validate_cancellation
)
...
class TenderReportingCancellationResource(APIResource):
    ...
    def cancel(self, cancellation):
        ...
        cancellation.tenderStatus = tender.status
    ...
    def collection_post(self):
        ...
        if save_tender(self.request):
            ...
            self.request.response.headers['Location'] = self.request.route_url(
                route_name='{}:Tender Cancellations'.format(tender.procurementMethodType),
